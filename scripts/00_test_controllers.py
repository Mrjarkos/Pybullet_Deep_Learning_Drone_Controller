...
if __name__ == "__main__":
    ...
    logger = []
    for i in drone_type:
        pySim = PybulletSimDrone(drone_type=i,
    ...
    plt.xlabel('Tiempo (s)')
    #plt.title(r'Respuesta ante escalón para el eje $\psi$')
    ...
    plt.legend([ctrls[0],  ctrls[1], 'Referencia'], loc='lower right')
